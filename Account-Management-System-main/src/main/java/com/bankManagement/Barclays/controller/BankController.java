...
public class BankController{
	...
	public ResponseEntity<Boolean> queryAccount(@RequestParam(name="pancard") String pancard) {
	...
	public ResponseEntity<List<BankAccount>> viewAccounts(@RequestParam(name="pancard") String pancard) {
	...
	public ResponseEntity<List<Transaction>> fiveTransaction(@RequestParam(name="accountNumber") String accountNumber) {
	...
	public ResponseEntity<List<Transaction>> detailedTransaction(@RequestParam (name="accountNumber")String accountNumber, @RequestParam(name="fromdate") String fromDate, @RequestParam (name="todate")String toDate) {
		List<Transaction> transaction = operations.detailedTransaction(accountNumber, fromDate, toDate);
		return new ResponseEntity<List<Transaction>>(transaction, HttpStatus.OK);
	}

	@PutMapping("/withdrawal")
	public ResponseEntity<String> cashWithdrawal(@RequestParam(name="accountNumber") String accountNumber, @RequestParam (name="amount") int amount) {
		String result;
		ResponseEntity<String> response;
	...
	@PutMapping("/deposit")
	public ResponseEntity<String> cashDeposit(@RequestParam(name="accountNumber") String accountNumber, @RequestParam(name="amount") int amount) {
		String result;
		ResponseEntity<String> response;
	...
	@PutMapping("/transfer")
	public ResponseEntity<String> transfer(@RequestParam(name="accountNumber1") String fromAccountNumber, @RequestParam(name="accountNumber2") String toAccountNumber,
	...
	public ResponseEntity<String> checkBalance(@RequestParam(name="accountNumber") String accountNumber){
